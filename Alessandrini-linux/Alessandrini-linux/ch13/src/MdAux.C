...
// ******************************************
//
//  This is file MdAux.C
//
//  We collect here a number of auxiliary functions used by
//  all the versions of the molecular dynamics code.
//
// ========================================================
...
// Variables used in this module by Grand()
// ----------------------------------------
double ransave;
int    flag;
Rand   RG(999);     // random generator, used by Gaussian generator

// Global variables declared in the main modules
// ---------------------------------------------
...
// Builds the D matrix. This function is taken from a DNA folding
// model
// --------------------------------------------------------------
...
// This is a Box-Muller Gaussian generator
// ---------------------------------------
double Grand()
   {
