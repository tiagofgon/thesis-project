...
// ******************************************
//
//  This is file MdOmp.C
//
//  OpenMP version of the parallel code
//
//  Macrotasking approach, employing a user defined task 
//  function. Work distribution among worker threads is done by
//  hand, by calling the ThreadRangeOmp auxiliary function.
//
//  For a description of the DMonitor auxiliary class, see
//  the initial comments in the Md.C file.
// ==============-----------------=======================
...
// the end.
// This is a task function, called by all the worker
// threads in the team.
// ------------------------------------------------
void ComputeTrajectory()
   {
...
int main(int argc, char **argv)
    ...
    for(sample=1; sample<=nSamples; ++sample)
        ...
        #pragma omp parallel 
            {
            ComputeTrajectory();  // execute task function
            }
