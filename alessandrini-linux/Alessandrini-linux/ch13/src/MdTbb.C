...
// ******************************************
//
//  This is file MdTbb.C
//
//  TBB microtasking version. As in MdOmpF.C, the code 
//  remains in sequential mode and loops are  parallelized 
//  as they are encountered using the TBB parallel_for 
//  algorithm.
// =======================================================
...
// Body class for the parallelization of the accelerations loop
// ------------------------------------------------------------
class Accelerations
   {
   public:
...
// Body class for the parallelization of the time step loop
// --------------------------------------------------------
class TimeStep
   {
   public:
...
// Body class for the parallelization of the energy computation,
