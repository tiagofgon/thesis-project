...
// File HeaTh_T.C
//
// Macrotasking version, using SPool and the high
// performance TbbBarrier. Compare with the performance
// of Heath2.C, which uses the standard barrier. 
// ----------------------------------------------------
...
TBarrier   *B;               // new, initialized by main
