...
// -------------------------------------------------------
// A Cell holds a matrix. Matrix operations are used to
// produce a significant number of cycles for the update()
// operation.
//
// Each Cell will be affected (randomly) an operation, one
// of the five of the enumeration above. According to the
