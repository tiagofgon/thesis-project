...
// File HeatNPa.C
// -----------
// Macrotasking, using the NPool pool. Same
// as HeatNP.C, but now we use a high performance
...
// and the global index range passed as input in
// Beg, End. On exit, Beg and End have the limits 
// of the thread range.
// ----------------------------------------------         
